...
#define LOG_TAG "OPENCV_AR_DEVLPX"
...
JNIEXPORT void JNICALL Java_com_example_ndk_1opencv_1androidstudio_OpenCVARView_FindFeatures(JNIEnv* env, jobject thiz, jint width, jint height, jbyteArray yuv, jintArray bgra)
{
    LOGI("jni starts");
...
JNIEXPORT void JNICALL Java_com_example_ndk_1opencv_1androidstudio_BitmapProcessing_GetCameraIntrisicParams(JNIEnv* env, jobject thiz)
{
    Size imageSize;
...
JNIEXPORT void JNICALL Java_com_example_ndk_1opencv_1androidstudio_Homography_doHomography(JNIEnv* env, jobject thiz, jstring filename)
{
    LOGI("load image");
